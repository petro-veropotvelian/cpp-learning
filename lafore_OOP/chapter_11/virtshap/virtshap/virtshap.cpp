...
public:
   shape() : xCo(0), yCo(0), fillcolor(cWHITE), fillstyle(SOLID_FILL)  // no-arg constructor
   {}
   shape(int x, int y, color fc, fstyle fs) :                          // 4-arg constructor
...
public:
   ...
   {}
   rect(int x, int y, int h, int w, color fc, fstyle fs)           // 6-arg constructor
...
public:
   ...
   {}
   tria(int x, int y, int h, color fc, fstyle fs)                  // 5-arg constructor
...
{
   int j;
   init_graphics();                                              // initialize grahpics system

   shape* pShapes[3];                                            // array of pointer to shapes
                                                                 // define three shapes
   pShapes[0] = new ball(40, 12, 5, cBLUE, X_FILL);              // create ball
   pShapes[1] = new rect(12, 7, 10, 15, cRED, SOLID_FILL);       // create rectangle
   pShapes[2] = new tria(60, 7, 11, cGREEN, MEDIUM_FILL);        // create triangle
