...
int main(int argc, char* argv[])
{
   ...
   if (isDerv1(d1))
   {
      cout << "d1 is a memeber of Derv1 class\n";
   }
   else
   {
      cout << "d1 is not a member of the Derv1 clas\n";
   }

   if (isDerv1(d2))
   {
      cout << "d2 is a memeber of Derv1 class\n";
   }
   else
   {
      cout << "d2 is not a member of the Derv1 clas\n";
   }
   return 0;
}